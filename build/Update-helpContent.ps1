...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "MyITProcess-PowerShellWrapper\docs"
        NO  - "MyITProcess-PowerShellWrapper\MyITProcessAPI\docs"

    Example: "C:\Celerium\Projects\MyITProcess-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "MyITProcess-PowerShellWrapper\docs"
    Reference:
        Yes - "MyITProcess-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "MyITProcess-PowerShellWrapper\MyITProcessAPI\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\MyITProcess-PowerShellWrapper\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/MyITProcess-PowerShellWrapper"
...
.EXAMPLE
    .\Update-helpContent.ps1
        -moduleName MyITProcessAPI
        -helpDocsPath "C:\Celerium\Projects\MyITProcess-PowerShellWrapper\docs"
        -csvFilePath "C:\Celerium\Projects\MyITProcess-PowerShellWrapper\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/MyITProcess-PowerShellWrapper"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the MyITProcess API.'
