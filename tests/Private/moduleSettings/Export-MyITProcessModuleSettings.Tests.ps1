<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-MyITProcessModuleSettings.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-MyITProcessModuleSettings.Tests.ps1 -Output Detailed
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "Should export successfully" {
            ...
            Export-MyITProcessModuleSettings -MyITProcessConfPath $exportPath -ErrorVariable moduleSettingsError -WarningAction SilentlyContinue
        ...
        It "Configuration file should contain required values" {
            ...
            $configFile = Import-LocalizedData -BaseDirectory $exportPath -FileName "config.psd1"
                ...
                $configFile.MyITProcess_Base_URI              | Should -Not -BeNullOrEmpty
                $configFile.MyITProcess_JSON_Conversion_Depth | Should -Not -BeNullOrEmpty
                $configFile.MyITProcess_API_Key               | Should -Not -BeNullOrEmpty
        }
