...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('apiKeys') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "Pipeline  - [ -Api_Key ] should return a secure string" {
            "MyITProcessApiKey" | Add-MyITProcessAPIKey
        ...
        It "Using [ -plainText ] should return [ -Api_Key ] as a string" {
            Add-MyITProcessAPIKey -Api_Key '12345'
            Get-MyITProcessAPIKey -plainText | Should -BeOfType String
        }

        It "If [ -Api_Key ] is empty it should throw a warning" {
            Remove-MyITProcessAPIKey
            Get-MyITProcessAPIKey -WarningAction SilentlyContinue -WarningVariable apiKeyWarning
