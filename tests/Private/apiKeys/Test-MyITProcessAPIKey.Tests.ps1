...
#Available inside It but NOT Describe or Context
    ...
    AfterAll{
        ...
        Remove-MyITProcessBaseUri -WarningAction SilentlyContinue
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('apiKeys') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "[ Test-MyITProcessAPIKey ] with a bad API key should fail to authenticate" {
            Add-MyITProcessBaseUri
            Add-MyITProcessAPIKey -Api_Key '12345'

            $Value = Test-MyITProcessAPIKey 3>$null
